...
import com.ua.semkov.smartsport.dao.UserRepository;
...
public class UserService {
    ...
    private static final String NOT_EXIST_ENTITIES = "Doesn't exist such users";
    ...
    public List<User> getAll() {
        ...
        try {
            ...
            throw new ServiceException("Failed to get list of all users", e);
        }
    }
